...
// PageToolbar is the toolbar for the Splunk plugin page. It allows a user to specify query and to select a start
...
const PageToolbar: React.FunctionComponent<IPageToolbarProps> = ({
  ...
  // changeOptions changes the Splunk option. If the options are changed via the refresh button of the Options
  ...
  return (
    <Toolbar id="splunk-toolbar" style={{ paddingBottom: '0px', zIndex: 300 }}>
