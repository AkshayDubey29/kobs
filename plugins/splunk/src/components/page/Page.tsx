...
const Page: React.FunctionComponent<IPluginPageProps> = ({ name, displayName, description }: IPluginPageProps) => {
  ...
  // changeOptions is used to change the options for an Splunk query. Instead of directly modifying the options
      ...
      <PageSection variant={PageSectionVariants.light}>
        <Title headingLevel="h6" size="xl">
          ...
          <span className="pf-u-font-size-md pf-u-font-weight-normal" style={{ float: 'right' }}>
            <a href="https://kobs.io/plugins/splunk/" target="_blank" rel="noreferrer">
              Documentation
            </a>
          </span>
        </Title>
