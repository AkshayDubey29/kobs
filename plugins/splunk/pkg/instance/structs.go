...
// Response is the structure of successful Splunk API call.
...
// Bucket is the structure of a bucket returned by the Splunk API.
type Bucket struct {
...
// ResponseError is the structure of failed Splunk API call.
